 ...
 * @return void
 */
var Activity = function Activity(activity) { 
  ...
  if (activity) { 
    ...
    this.getUserName = function(authorId, capitalize) { 
      if (authorId === Meteor.userId()) { return capitalize ? 'you'.capitalize() : 'you'; }
      else { return getUserName(authorId); } // scopes out to getUserName defined in users-collection.js
    }

    this.performer = this.getUserName(activity.action.user, true);
 ...
 * @type {Activity}
 */
var CommentActivity = function CommentActivity(activity) { 
 ...
 * @type {Activity}
 */
var SqueakDeletedFromAxleActivity = function SqueakDeletedFromAxleActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
 ...
 * @type {Activity} 
 */
var SqueakEditedActivity = function SqueakEditedActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  ...
  if (edit) { 
    ...
    this.linkPath = 'squeakPage';
    this.performer = this.getUserName(edit.user, true);
    this.template = '_edit';
 ...
 * @type {Activity}
 */
var SqueakRemovedFromAxleActivity = function SqueakRemovedFromAxleActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  var axle = Axles.findOne({_id: this.activity.watched._id});
  if (axle) { // may need to wait on a subscription here.
 ...
 * @type {Activity}
 */
var SqueakTaggedToAxleActivity = function SqueakTaggedToAxleActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  var axle = Axles.findOne({_id: this.activity.watched._id});
 ...
 * @type {Activity}
 */
var TutorialExampleActivity = function TutorialExampleActivity(activity) { 
  _.extend(this, new Activity(activity)) // extend Activity
 ...
 */
var UserJoinedActivity = function UserJoinedActivity(activity) { 
  _.extend(this, new Activity(activity)) // extend Activity
 ...
 * @type {Activity}
 */
var WatchedSqueakDeletedActivity = function WatchedSqueakDeletedActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend  Activity.
 ...
 * @type {Activity}
 */
var WorkflowMotionCommentActivity = function WorkflowMotionCommentActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  var squeak = Squeaks.findOne({_id: activity.watched._id});
  var motion;
  if (squeak) { 
    ...
    this.action = 'commented on ' + possessivize(this.getUserName(motion.user, false)) + ' proposal to change '; 
    this.linkText = squeak.title;
    this.linkPath = 'squeakPage';
    this.linkId = squeak._id;
    this.performer = this.getUserName(comment.author, true);
 ...
 * @type {Activity}
 */
var WorkflowMotionInitiatedActivity = function WorkflowMotionInitiatedActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  var squeak = Squeaks.findOne({_id: activity.watched._id});
  var motion;
  if (squeak) { 
    motion = _.findWhere(squeak.motions, {_id: activity.action._id});
    this.action = 'proposed that workflow state of ';
    this.linkText = squeak.title;
    this.linkId = squeak._id;
    this.linkPath = 'squeakPage';
    this.postLinkText = ' change from ' + motion.previousState + ' to ' + motion.proposedState;
    this.performer = this.getUserName(motion.user, true);
 ...
 * @type {Activity}
 */
var WorkflowMotionResolvedActivity = function WorkflowMotionResolvedActivity(activity) { 
  _.extend(this, new Activity(activity)); // extend Activity
  var squeak = Squeaks.findOne({_id: activity.watched._id});
  var motion;
  if (squeak) { 
    motion = _.findWhere(squeak.motions, {_id: activity.action._id});
    this.action = ' proposal to change ';
    this.performer = possessivize(this.getUserName(motion.user, true));
    this.linkText = squeak.title;
    this.linkId = squeak._id;
    this.linkPath = 'squeakPage';
